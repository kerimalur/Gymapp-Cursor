  ...
  return (
    <div className="relative">
      ...
      {hoveredMuscle && !selectedMuscle && (() => {
        ...
        return (
          <div className="absolute top-4 right-4 bg-[hsl(225,14%,10%)] rounded-xl shadow-lg p-4 border border-[hsl(225,10%,16%)] min-w-[180px]">
            <div className="flex items-center gap-2 mb-2">
              <h4 className="font-semibold text-[hsl(var(--fg-primary))]">
                {info.name}
              </h4>
              {info.isSecondary && (
                <span className="px-1.5 py-0.5 text-[10px] font-medium bg-[hsl(225,12%,15%)] text-[hsl(var(--fg-muted))] rounded">
                  Hilfs
                </span>
              )}
            </div>
            ...
            {info.isSecondary && (
              <p className="text-xs text-[hsl(var(--fg-subtle))] mt-2">Zuletzt als Hilfsmuskel trainiert</p>
            )}
            <p className="text-xs text-[hsl(var(--fg-subtle))] mt-1">Klicken für Details</p>
          </div>
        );
      })()}
