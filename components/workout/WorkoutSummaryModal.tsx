          ...
          <div className="p-6 space-y-5">
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <p className="text-xs text-emerald-500">Saetze</p>
            ...
            {summary.newPRs.length > 0 && (
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-amber-800">Neue Persoenliche Rekorde!</h3>
                </div>
            ...
            <div>
              ...
              >
                <span className="font-semibold text-slate-700 text-sm">Uebungen im Detail</span>
                      ...
                      {summary.exerciseInsights.map((insight, i) => (
                        <div key={insight.exerciseId} className="bg-slate-50 rounded-xl p-3">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs text-slate-500">{insight.setsCompleted} Saetze</span>
                          </div>
            ...
            {summary.nextWorkoutTips.length > 0 && (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-bold text-blue-800 text-sm">Fuer naechstes Mal</h3>
                </div>
