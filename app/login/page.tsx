        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 animate-fade-in">
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">Cloud-Sync - Deine Daten überall verfügbar</p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 font-semibold py-4 px-6 rounded-xl transition-all duration-200 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
            ...
            {isSigningIn ? 'Wird angemeldet...' : 'Mit Google anmelden'}
          </button>
